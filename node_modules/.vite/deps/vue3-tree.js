...
// node_modules/vue3-tree/dist/vue3-tree.mjs
...
var _hoisted_2$3 = createVNode("polyline", { points: "9 18 15 12 9 6" }, null, -1);
...
var _hoisted_2$2 = createVNode("polyline", { points: "6 9 12 15 18 9" }, null, -1);
...
var _hoisted_2$1 = createVNode("line", {
  x1: "18",
  y1: "6",
  x2: "6",
  y2: "18"
}, null, -1);
var _hoisted_3$1 = createVNode("line", {
  x1: "6",
  y1: "6",
  x2: "18",
  y2: "18"
...
var _hoisted_2 = { class: "tree-row-txt" };
var _hoisted_3 = { class: "child-count" };
...
var updateNodes = (nodes) => nodes.map((node) => {
  var _a;
...
var searchNodes = (nodes, searchText) => {
...
var setNodeById = (nodes, id, newNode) => nodes.map((node) => {
  if (node.id === id) {
...
var updateNodeById = (nodes, id, newNode) => nodes.map((node) => {
...
var _withId = withScopeId("data-v-62a5b360");
pushScopeId("data-v-62a5b360");
var _hoisted_1 = { class: "tree" };
popScopeId();
var _sfc_render = _withId((_ctx, _cache, $props, $setup, $data, $options) => {
...
//# sourceMappingURL=vue3-tree.js.map
